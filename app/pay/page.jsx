...
export default function page() {
    ...
    useEffect(() => {
        ...
        const getitemsapi = async() => {
          const getdata = await axios.post("http://localhost:4000/getcartitems" , {
            ...
            const discount = SaleSum * totaldiscount / 100 

            {discount ?            setdiscount(Math.floor(discount)) : setdiscount(0)}


                  
            settotalprice(Math.floor(SaleSum + totalSum))
  ...
  return (
    <>
    <Header></Header>
<section class="bg-white payment py-8 antialiased dark:bg-gray-900 md:py-16">
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div class="mx-auto max-w-5xl">
      <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Payment</h2>

      <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
        <form onSubmit={(e) => payment(e)} class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
          ...
          <input value='Pay Now'  type='submit'   class="flex cursor-pointer paynowbtn bg-sky-500 w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"/>
        </form>
          ...
          <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            <div class="space-y-2">
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">{Math.floor(totalprice)}ლ</dd>
              </dl>

              <dl class="flex items-center justify-between gap-4">
                <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                <dd class="text-base font-medium text-green-500">-{Math.floor(discount)}ლ</dd>
              </dl>
            ...
            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd class="text-base font-bold text-gray-900 dark:text-white">{Math.floor(totalprice  - discount)} ლ</dd>
            </dl>
          </div>
